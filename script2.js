...
return("");}
async function DownSoft(){var u=navigator.userAgent;var isiOS=!!u.match(/\(i[^;]+;( U;)? CPU.+Mac OS X/);var isAndroid=u.indexOf('Android')>-1||u.indexOf('Adr')>-1;let gameId=getQueryVariable("from_gameid")
let code=getQueryVariable("channelCode")
let copyObj={from_gameid:"43673081",channelCode:"code"}
let copyStr=JSON.stringify(copyObj)
copyText(copyStr,function(){console.log('copy successful',copyStr)})
if(isiOS){window.location.href="https://refer9.com/4ocvgl54"}
else if(isAndroid){window.location.href="https://refer9.com/4ocvgl54"}
else{window.location.href="https://refer9.com/4ocvgl54"}}